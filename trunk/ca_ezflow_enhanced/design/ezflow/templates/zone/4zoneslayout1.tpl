...
<div class="border-content zone" id="0--{$zones[0].zone_identifier}--{$attribute.id}--{$attribute.version}"> 
...
{if or( $block.valid_nodes|count(), 
    ...
    <div class="sortable-block" id="address-{$block.zone_id}-{$block.id}">
...
<div class="border-tl"><div class="border-tr"><div class="border-tc"></div></div></div>
<div class="border-ml"><div class="border-mr"><div class="border-mc">
<div class="border-content zone" id="2--{$zones[2].zone_identifier}--{$attribute.id}--{$attribute.version}">
...
<div class="border-tl"><div class="border-tr"><div class="border-tc"></div></div></div>
<div class="border-ml"><div class="border-mr"><div class="border-mc">
<div class="border-content zone" id="3--{$zones[3].zone_identifier}--{$attribute.id}--{$attribute.version}">
...
<div class="border-tl"><div class="border-tr"><div class="border-tc"></div></div></div>
<div class="border-ml"><div class="border-mr"><div class="border-mc">
<div class="border-content zone" id="1--{$zones[1].zone_identifier}--{$attribute.id}--{$attribute.version}">
